    ...
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : BaseEntity
    {
        ...
        public virtual ServiceResult AddEntity(TEntity entity)
        {
            ...
            if (isValidate == true)
            {
                ...
                _serviceResult.MisaCode = MISAEnum.IsValid;//vieets hoa
        ...
        protected bool Validate(TEntity entity)
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (property.IsDefined(typeof(CheckDuplicate), false))
                {
                    ...
                    {
                        isCheckDuplicateCode = true;
                        isValidate = false;
                        //messArrayError.Add(string.Format(Properties.Resources.Msg_Duplicate, displayName));
                        _serviceResult.Data = new
                        {
                            devMsg = string.Format(Properties.Resources.Msg_Duplicate, displayName),
                            userMsg = string.Format(Properties.Resources.Msg_Duplicate, displayName)
                        };
                        _serviceResult.MisaCode = MISAEnum.NotValid;
                        _serviceResult.Messeger = Properties.Resources.Msg_IsNotValid;
                    }
                ...
                if (property.IsDefined(typeof(MaxLength), false))
                {
                    ...
                    if(propertyValue != null)
                    {
                        if (propertyValue.ToString().Trim().Length > length)
                        {
                            ...
                            _serviceResult.Data = new
                            {
                                devMsg = string.Format(Properties.Resources.Msg_NotValidMaxLength, displayName , length),
                                userMsg = string.Format(Properties.Resources.Msg_NotValidMaxLength, displayName , length)
                            };
                            _serviceResult.MisaCode = MISAEnum.NotValid;
                            _serviceResult.Messeger = Properties.Resources.Msg_IsNotValid;
